        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2">
                ...
                <x-card title="Bank Details">
                    <div class="grid gap-4 sm:grid-cols-2">
                        <x-input label="Bank name" name="bank_name" value="{{ old('bank_name', $user->staffProfile?->bank_name) }}" placeholder="e.g. HDFC Bank" />
                        <x-input label="Account number" name="bank_account" value="{{ old('bank_account', $user->staffProfile?->bank_account) }}" placeholder="e.g. 50100234567890" />
                        <x-input label="IFSC code" name="bank_ifsc" value="{{ old('bank_ifsc', $user->staffProfile?->bank_ifsc) }}" placeholder="e.g. HDFC0001234" />
                    </div>

<x-layouts.guest title="Enter Reset Code">
    @php
    ...
    <div class="flex min-h-screen items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="animate-slide-up text-center">
                ...
                <h2 class="mt-4 text-2xl font-bold tracking-tight text-ink-900 dark:text-white">Enter reset code</h2>
                <p class="mt-1 text-sm text-ink-500 dark:text-ink-400">We sent a 6-digit code to <span class="font-semibold text-ink-700 dark:text-ink-200">{{ $email }}</span>. Enter it below to reset your password.</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.otp') }}" class="card mt-8 animate-slide-up">
                @csrf

<x-layouts.app
    title="New Diet Plan"
    description="Create a diet plan for a client."
    :breadcrumbs="[['label' => 'Diet Plans', 'url' => route('diets.index')], ['label' => 'New Diet Plan']]">

    <form method="POST" action="{{ route('diets.store') }}" x-data="dietForm()">
        @csrf
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="space-y-6 lg:col-span-2">
                <x-card title="Plan Details">
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <x-input label="Plan name" name="name" value="{{ old('name') }}" required placeholder="e.g. Lean Bulk 2500" />
                        </div>
                        <div class="sm:col-span-2">
                            <x-input label="Goal" name="goal" value="{{ old('goal') }}" placeholder="e.g. Lose fat, gain muscle" />
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('diets.index') }}" class="btn-outline">Cancel</a>
                </div>
            </div>
        </div>
    </form>

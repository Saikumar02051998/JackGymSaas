<x-layouts.app
    title="Trial Members"
    description="Track free-trial members and convert them into paying clients."
    ...
    @if ($trials->isEmpty())
        <x-card>
            <div class="p-8">
                <x-empty-state icon="gift" title="No trial members" message="Trials given to new clients will appear here." />
            </div>
        </x-card>
    @else

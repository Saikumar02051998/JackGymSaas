<div x-data="toast()" class="pointer-events-none fixed inset-x-0 top-4 z-[100] flex flex-col items-center gap-2 px-4 sm:items-end sm:pr-6">
    <template x-for="toast in toasts" :key="toast.id">
        <div class="pointer-events-auto flex w-full max-w-sm items-start gap-3 rounded-2xl border bg-white p-4 shadow-xl animate-slide-in-right dark:bg-night-900"
            ...
            <button @click="dismiss(toast.id)" class="shrink-0 rounded-lg p-1 text-ink-400 hover:bg-ink-100 dark:hover:bg-ink-800">
